...
@Repository
public interface RouteRedirectToFilterRepository
    extends JpaRepository<RouteRedirectToFilter, Long> {

  @Modifying
  @Transactional
  @Query("DELETE FROM RouteRedirectToFilter f WHERE f.route = :route")
