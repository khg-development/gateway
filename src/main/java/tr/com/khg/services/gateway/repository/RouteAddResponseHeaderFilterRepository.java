...
public interface RouteAddResponseHeaderFilterRepository
    extends JpaRepository<RouteAddResponseHeaderFilter, Long> {
    @Modifying
    @Transactional
    @Query("DELETE FROM RouteAddResponseHeaderFilter f WHERE f.route = :route")
